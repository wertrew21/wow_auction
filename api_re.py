...
def price_quantity(s):              # input for s is supposed to be 'hist_join'(refer to api_read.py)
    item_list = p_ipq.findall(s)                    # item_list[0] = ("id0", "total_prc0", "qty0")                             
    ...
    return id_prc_qty             # {'id':[('PRC0', 'QTY0'), ('PRC1', 'QTY1'), ... ]), ...  ( ... )]
